---
title: REST / Webhook Source Adapter
tags: [source, cdc, rest, scaffold]
status: scaffold
---

# REST / Webhook Source Adapter

REST / Webhook coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/rest-source.json.example`.
