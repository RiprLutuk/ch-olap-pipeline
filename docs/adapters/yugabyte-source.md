---
title: YugabyteDB Source Adapter
tags: [source, cdc, yugabyte, scaffold]
status: scaffold
---

# YugabyteDB Source Adapter

YugabyteDB coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/yugabyte-source.json.example`.
