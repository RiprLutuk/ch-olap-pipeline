---
title: Oracle Source Adapter
tags: [source, cdc, oracle, scaffold]
status: GA scaffold
---

# Oracle Source Adapter

Oracle coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/oracle-source.json.example`.
