---
title: SQLite Source Adapter
tags: [source, cdc, sqlite, scaffold]
status: scaffold
---

# SQLite Source Adapter

SQLite coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/sqlite-source.json.example`.
