---
title: Firebird Source Adapter
tags: [source, cdc, firebird, scaffold]
status: scaffold
---

# Firebird Source Adapter

Firebird coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/firebird-source.json.example`.
