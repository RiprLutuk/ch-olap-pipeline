---
title: CockroachDB Source Adapter
tags: [source, cdc, cockroachdb, scaffold]
status: scaffold
---

# CockroachDB Source Adapter

CockroachDB coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/cockroachdb-source.json.example`.
