---
title: Kafka-native Source Adapter
tags: [source, cdc, kafka, scaffold]
status: scaffold
---

# Kafka-native Source Adapter

Kafka-native coverage is included so the project can grow beyond the default PostgreSQL/MySQL/SQL Server path.
...
See `deploy/kafka-debezium/connectors/kafka-source.json.example`.
