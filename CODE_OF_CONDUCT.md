...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, comments, and any other channel used for project communication. It also applies when an individual is officially representing the project in public spaces (for example, using an official project email address, posting via an official social media account, or acting as an appointed representative at an online or offline event).
...
- Security / private reporting: https://github.com/RiprLutuk/ch-olap-pipeline/security/advisories
